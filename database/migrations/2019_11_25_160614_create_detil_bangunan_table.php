...
class CreateDetilBangunanTable extends Migration {
	...
	public function up()
	{
		Schema::create('detil_bangunan', function(Blueprint $table)
		{
			...
			$table->string('koordinatlokasi', 1000)->nullable();
			...
			$table->integer('statustanah')->nullable();
		});
	}
