...
<div class="form-group col-sm-6 row">
    ...
    {!! Form::text('koordinatlokasi', null, ['class' => 'form-control koordinatlokasi', 'id' => 'koordinatlokasi-detilbangunan', 'data-bind' => 'value: viewModel.data["KIB C"]().koordinatlokasi']) !!}
</div>
