...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('koordinatlokasi', null, ['class' => 'form-control koordinatlokasi', 'id' => 'koordinatlokasi-detilkonstruksi', 'data-bind' => 'value: viewModel.data["KIB F"]().koordinatlokasi']) !!}
</div>
